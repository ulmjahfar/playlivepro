    ...
    () => [
      {
        ...
        icon: '➕',
        action: () => navigate('/dashboard/superadmin/tournaments/create')
      },
      {
        label: 'Manage Tournaments',
        helper: 'Full inventory',
        icon: '📋',
        action: () => navigate('/dashboard/superadmin/tournaments')
      },
      {
        label: 'Open Reports',
        helper: 'Insights & exports',
        icon: '📊',
        action: () => navigate('/dashboard/superadmin/reports')
      },
      {
        label: 'Audit Logs',
        helper: 'Track every change',
        icon: '🕵️',
        action: () => navigate('/dashboard/superadmin/audit')
      },
      {
        label: 'System Settings',
        helper: 'Feature flags & access',
        icon: '⚙️',
        action: () => navigate('/dashboard/superadmin/settings')
      }
    ],
    [navigate]
  );
